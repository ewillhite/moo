...
if (drupal_is_front_page()) {
  ...
  drupal_add_js(drupal_get_path('theme', 'moo') .'/assets/js/front-ck.js', array('group' => JS_THEME));
}
...
function moo_views_pre_render(&$view) {
  ...
  if($view->name == 'private_work') {
  	...
  	drupal_add_js(drupal_get_path('theme', 'moo') .'/assets/js/private-work-ck.js', array('group' => JS_THEME));
  }
}
